...
!function (t, e) {
    ...
    function I(t, e) {
        var i = 1 < arguments.length && void 0 !== e ? e : 1, e = String(Math.abs(t)), a = e.length, s = "";
    ...
    var S, P = /\d+/g, N = {
        show: function () {
            ...
            var i = this.options, a = i.monthsShort, i = i.months;
        ...
        click: function (t) {
            var e = k(t.target), i = this.options, a = this.date, s = this.viewDate, n = this.format;
            if (t.stopPropagation(), t.preventDefault(), !e.hasClass("disabled")) {
                var r = e.data("view"), h = s.getFullYear(), o = s.getMonth(), t = s.getDate();
                switch (r) {
                    case"years prev":
                    case"years next":
            ...
            var e = t.target, i = t.key, t = t.keyCode;
        ...
        render: function () {
            ...
            var i = this, a = [], t = this.options, e = t.weekStart, t = t.daysMin, e = parseInt(e, 10) % 7, t = t.slice(e).concat(t.slice(0, e));
            k.each(t, function (t, e) {
            ...
            for (var t = this.options, e = this.startDate, i = this.endDate, a = this.viewDate, s = t.disabledClass || "", n = t.monthsShort, r = k.isFunction(t.filter) && t.filter, h = a.getFullYear(), a = new Date, o = a.getFullYear(), l = a.getMonth(), c = this.date.getFullYear(), d = this.date.getMonth(), u = [], p = !1, f = !1, g = 0; g <= 11; g += 1) {
                ...
                var v = h === c && g === d, w = v ? "month picked" : "month";
            ...
            var t, e = this.$element, i = this.options, a = this.startDate, s = this.endDate, n = this.viewDate, r = this.date, h = i.disabledClass, o = i.filter, l = i.months, c = i.weekStart, d = i.yearSuffix, u = n.getFullYear(), p = n.getMonth(), n = new Date, f = n.getFullYear(), g = n.getMonth(), y = n.getDate(), m = r.getFullYear(), v = r.getMonth(), w = r.getDate(), k = [], D = u, b = p, n = !1;
            0 === p ? (--D, b = 11) : --b, t = O(D, b);
            var C, r = new Date(u, p, 1);
            for ((C = r.getDay() - parseInt(c, 10) % 7) <= 0 && (C += 7), a && (n = r.getTime() <= a.getTime()), P = t - (C - 1); P <= t; P += 1) {
                var $ = new Date(D, b, P), x = !1;
            ...
            for (s && (c = r.getTime() >= s.getTime()), P = 1; P <= C; P += 1) {
                var V = new Date(M, Y, P), T = M === m && Y === v && P === w, I = !1;
    ...
    }, A = "".concat(l, "-top-left"), t = "".concat(l, "-top-right"), W = "".concat(l, "-bottom-left"), e = "".concat(l, "-bottom-right"), z = [A, t, W, e].join(" "), J = function () {
        function i(t) {
            ...
            !function (t, e) {
                ...
                var i = 1 < arguments.length && void 0 !== e && e, a = k(t), s = "absolute" === (e = a.css("position")), n = i ? /auto|scroll|hidden/ : /auto|scroll/, a = a.parents().filter(function (t, e) {
                    e = k(e);
        ...
        return t = i, a = [{
            ...
            key: "init", value: function () {
                ...
                this.$trigger = k(e.trigger), this.isInput = t.is("input") || t.is("textarea"), this.inline = e.inline && (e.container || !this.isInput), this.format = function (i) {
                    ...
                    return i = {source: t, parts: e}, k.each(e, function (t, e) {
                        switch (e) {
                            case"dd":
                            case"d":
                                i.hasDay = !0;
            ...
            key: "setValue", value: function (t) {
                var e = 0 < arguments.length && void 0 !== t ? t : "", t = this.$element;
    ...
    k.extend && k.extend(J.prototype, q, j, N), k.fn && (S = k.fn.datepicker, k.fn.datepicker = function (r) {
        ...
        return this.each(function (t, e) {
            var i = k(e), a = "destroy" === r;
            if (!(n = i.data(l))) {
                if (a)return;
                var s = k.extend({}, i.data(), k.isPlainObject(r) && r), n = new J(e, s);
                i.data(l, n)
            }
